...
const adminDashboard = () => {
  ...
  return (
    <div class="bg-homebg min-h-screen flex-inline">
      <div class="bg-header">
        {/* <Link href="/">
      ...
      <aside class="w-64" aria-label="Sidebar">
        <div class="overflow-y-auto py-4 px-3 h-screen bg-header rounded-b-xl dark:bg-gray-800">
          <ul class="space-y-2">
            <li>
              <a
                href="#"
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 font-bold whitespace-nowrap">Log Out</span>
              </a>
            </li>
            {/* <li>
              <a
